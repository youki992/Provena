...
const HITL_LOGS_PAGE_SIZE_KEY = 'provena_hitl_logs_page_size';
const HITL_PENDING_PAGE_SIZE_KEY = 'provena_hitl_pending_page_size';
...
function readHitlLocalStorageConv(conversationId) {
    ...
    try {
        const key = 'provena-chat-hitl:' + String(conversationId).trim();
