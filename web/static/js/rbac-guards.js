...
(function () {
    ...
    const GLOBAL_WRITE_HANDLER_PERMISSIONS = {
        ...
        showAddLocalToolModal: 'config:write',
        saveLocalTool: 'config:write',
        editLocalTool: 'config:write',
        deleteLocalTool: 'config:write',
        toggleLocalTool: 'config:write',
        ...
        savePacketCaptureConfig: 'config:write',
        installPacketCaptureCA: 'config:write',
