...
The Workflows page provides a **Create from natural language** entry point. After a user describes a security operations goal, Provena generates an editable draft and returns a structured audit result:
