...
const (
	...
	ToolSearchSpaceAssets = "search_space_assets"
	...
	// ToolQueryExecutionResult is the legacy name retained for compatibility
	// with older tool manifests and Pi prompts.
	ToolQueryExecutionResult = "query_execution_result"
