...
type Tool struct {
	...
	// Local marks a normal command-line tool configured under security.tools.
	// It is metadata for Harness/UI routing; execution still goes through the
	// same authenticated in-process tool service.
