...
func subAgentFilesystemMiddleware(
	...
	cfg := &filesystem.MiddlewareConfig{
		Backend:             loc,
		WriteFileToolConfig: &filesystem.ToolConfig{Disable: readOnly},
		EditFileToolConfig:  &filesystem.ToolConfig{Disable: readOnly},
	}
	if !readOnly {
		cfg.StreamingShell = &einoStreamingShellWrap{
