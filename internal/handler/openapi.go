	...
	spec := map[string]interface{}{
		...
		"components": map[string]interface{}{
			...
			"schemas": map[string]interface{}{
				...
				"BuiltinToolTestRequest": map[string]interface{}{
					"type":        "object",
					"description": "内置工具试运行参数。工具具体字段以 /api/config/tools/{name}/schema 返回的 input_schema 为准。",
					"properties": map[string]interface{}{
						"arguments": map[string]interface{}{
							"type":                 "object",
							"description":          "传给内置工具的 JSON 对象参数",
				...
				"ExternalMCPConfig": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						"type": map[string]interface{}{
							...
							"description": "传输方式；stdio 可省略并由 command 推断",
						},
						"transport": map[string]interface{}{
							"type":        "string",
							"enum":        []string{"stdio", "http", "sse"},
							"description": "旧版传输方式字段；新配置请使用 type",
						},
						"command": map[string]interface{}{
							"type":        "string",
							"description": "stdio MCP Server 命令",
						},
						...
						"url": map[string]interface{}{
							"type":        "string",
							"format":      "uri",
							"description": "HTTP/SSE MCP Server 地址",
						},
						...
						"disabled": map[string]interface{}{
							"type":        "boolean",
							"description": "是否禁用（官方 MCP 配置字段）",
						},
						"autoApprove": map[string]interface{}{
							"type":        "array",
							"items":       map[string]interface{}{"type": "string"},
							"description": "自动批准的工具名列表",
						},
						"max_retries": map[string]interface{}{
							"type":        "integer",
							"minimum":     0,
							"description": "Streamable HTTP 重试次数",
						},
						"terminate_duration": map[string]interface{}{
							"type":        "integer",
							"minimum":     0,
							"description": "stdio 进程优雅关闭等待秒数",
						},
						"keep_alive": map[string]interface{}{
							"type":        "integer",
							"minimum":     0,
							"description": "客户端心跳间隔秒数，0 表示禁用",
						},
						"timeout": map[string]interface{}{
							"type":        "integer",
							"minimum":     1,
							"description": "连接/请求超时秒数",
						},
						"description": map[string]interface{}{
							"type":        "string",
							"description": "工具用途说明，供 Agent 选择工具时参考",
						},
						"external_mcp_enable": map[string]interface{}{
							"type":        "boolean",
							"description": "是否启用外部 MCP",
						},
					},
				},
				"ExternalMCPResponse": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"status": map[string]interface{}{
							"type":        "string",
							"description": "状态",
							"enum":        []string{"connected", "connecting", "disconnected", "error", "disabled"},
						},
		...
		"paths": map[string]interface{}{
			...
			"/api/config/tools/{name}/test": map[string]interface{}{
				"post": map[string]interface{}{
					"tags":        []string{"配置管理"},
					"summary":     "试运行内置工具",
					"description": "使用提供的 JSON 参数真实调用已注册的内置工具，并返回执行 ID、结果和错误信息。需要 mcp:execute 权限。",
					"operationId": "testBuiltinTool",
					"parameters": []map[string]interface{}{{
						"name":        "name",
						"in":          "path",
						"required":    true,
					...
					"requestBody": map[string]interface{}{
						...
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
								"schema": map[string]interface{}{"$ref": "#/components/schemas/BuiltinToolTestRequest"},
							},
						},
					},
					"responses": map[string]interface{}{
						"200": map[string]interface{}{"description": "工具调用完成，ok 字段表示工具是否报告错误"},
						"400": map[string]interface{}{"description": "参数错误或工具名称不是内置工具"},
						"401": map[string]interface{}{"description": "未授权"},
						"404": map[string]interface{}{"description": "工具未找到或未启用"},
						"502": map[string]interface{}{"description": "工具执行失败"},
					},
				},
			},
			...
			"/api/external-mcp/{name}": map[string]interface{}{
				...
				"put": map[string]interface{}{
					"tags":        []string{"外部MCP管理"},
					"summary":     "添加或更新外部MCP",
					"description": "添加新的外部MCP配置或更新现有配置。\n**stdio 示例**：\n```json\n{\n  \"config\": {\n    \"type\": \"stdio\",\n    \"command\": \"node\",\n    \"args\": [\"/path/to/mcp-server.js\"],\n    \"env\": {},\n    \"description\": \"Node.js MCP Server\"\n  }\n}\n```\n**Streamable HTTP 示例**：\n```json\n{\n  \"config\": {\n    \"type\": \"http\",\n    \"url\": \"https://mcp.example.com/mcp\",\n    \"headers\": {\"Authorization\": \"Bearer ${MCP_TOKEN}\"},\n    \"timeout\": 30\n  }\n}\n```\n**说明**：配置保存后默认启用；通过 start/stop 控制运行状态。支持 `type` 为 `stdio`、`http`、`sse`，以及环境变量、请求头、超时、重试、心跳和 stdio 关闭等待等字段。保存后可调用 validate，再调用 test 验证具体工具。",
			...
			"/api/external-mcp/{name}/validate": map[string]interface{}{
				"post": map[string]interface{}{
					"tags":        []string{"外部MCP管理"},
					"summary":     "验证外部MCP连接和工具列表",
					"description": "执行真实 MCP handshake 和 tools/list，返回连接状态、耗时及工具 schema；成功后保留连接供 Agent 使用",
					"operationId": "validateExternalMCP",
					"parameters": []map[string]interface{}{
						{
							"name":        "name",
							"in":          "path",
					...
					"responses": map[string]interface{}{
						"200": map[string]interface{}{
							"description": "连接和 tools/list 验证成功",
							"content": map[string]interface{}{
								"application/json": map[string]interface{}{
									"schema": map[string]interface{}{
										"type": "object",
										"properties": map[string]interface{}{
											...
											"tool_count":  map[string]interface{}{"type": "integer"},
						...
						"400": map[string]interface{}{"description": "配置无效"},
						"404": map[string]interface{}{"description": "MCP不存在"},
						"502": map[string]interface{}{"description": "握手或 tools/list 失败，响应包含 error"},
						"401": map[string]interface{}{"description": "未授权"},
					},
				},
			},
			"/api/external-mcp/{name}/test": map[string]interface{}{
				"post": map[string]interface{}{
					"tags":        []string{"外部MCP管理"},
					"summary":     "测试外部MCP工具",
					"description": "使用 JSON 参数调用一个已发现的外部 MCP 工具",
					"operationId": "testExternalMCPTool",
					"parameters": []map[string]interface{}{
						{
							"name":        "name",
							"in":          "path",
					...
					"responses": map[string]interface{}{
						"200": map[string]interface{}{"description": "工具调用完成；工具自身报错时 ok=false"},
						"400": map[string]interface{}{"description": "请求参数错误"},
						"502": map[string]interface{}{"description": "工具调用失败，响应包含 error"},
						"401": map[string]interface{}{"description": "未授权"},
					},
				},
			},
			...
			"/api/fofa/search": map[string]interface{}{
				"post": map[string]interface{}{
					...
					"summary":     "FOFA搜索",
					"description": "通过后端代理执行 FOFA、ZoomEye、Quake 或 Shodan 搜索查询，返回资产信息。FOFA 需要邮箱和 API Key。",
						...
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
								"schema": map[string]interface{}{
									...
									"required": []string{"query"},
									"properties": map[string]interface{}{
										"provider": map[string]interface{}{"type": "string", "enum": []string{"fofa", "zoomeye", "quake", "shodan"}, "description": "数据源，默认 fofa"},
										"query":    map[string]interface{}{"type": "string", "description": "对应数据源的查询语法", "example": "domain=\"example.com\""},
