...
func init() {
	schema.RegisterName[*WorkflowLocalState]("_provena_workflow_local_state")
	schema.RegisterName[NodeOutputEnvelope]("_provena_workflow_node_output_envelope")
	schema.RegisterName[StartOutput]("_provena_workflow_start_output")
	schema.RegisterName[ConditionOutput]("_provena_workflow_condition_output")
	schema.RegisterName[ToolOutput]("_provena_workflow_tool_output")
	schema.RegisterName[AgentOutput]("_provena_workflow_agent_output")
	schema.RegisterName[HITLOutput]("_provena_workflow_hitl_output")
	schema.RegisterName[OutputNodeOutput]("_provena_workflow_output_node_output")
}
