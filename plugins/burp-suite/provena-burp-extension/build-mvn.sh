...
if command -v mvn >/dev/null 2>&1; then
  ...
  MAVEN_VERSION="3.9.6"
  BASE_DIR="${HOME}/.cache/provena-burp-extension"
...
cp "$ROOT_DIR/target/provena-burp-extension-1.0.0.jar" "$DIST_DIR/provena-burp-extension.jar"
echo "[+] Done: $DIST_DIR/provena-burp-extension.jar"
