...
Chromium DevTools extension: capture Network traffic and send it to Provena for AI-assisted security testing. Aligned with the Burp Suite plugin.

### Quick install

1. `chrome://extensions/` → Developer mode → **Load unpacked**
2. Select `plugins/browser-extension/provena-browser-extension/`
3. Open target page → **F12** → **Provena** tab → **Validate**
